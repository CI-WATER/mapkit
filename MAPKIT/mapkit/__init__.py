...
def lookupSpatialReferenceID(wellKnownText):
    ...
    try:
        ...
        print "SRID Lookup Error: Could not automatically determine spatial reference ID, because there is no internet connection. Please check connection and try again."
        exit(1)
